...
- `SOW-0100-20260608-consumer-docs-github-wiki.md` - in-progress regression repair. GitHub code scanning retained stale markdownlint alerts because clean Codacy uploads used a different SARIF tool name.
