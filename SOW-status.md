...
- `SOW-0100-20260608-consumer-docs-github-wiki.md` - in-progress regression repair. The post-closure Codacy SARIF run failed on markdownlint spacing in the SOW status ledgers.
