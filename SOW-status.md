...
- `SOW-0100-20260608-consumer-docs-github-wiki.md` - completed after regression repair. The GitHub wiki was initialized and published; `Publish Wiki` run `27134486131` passed, wiki HEAD is `96544031d0d540c1137a415d7cea7f7ab7eab50f`, Codacy SARIF run `27137079004` passed with explicit stale-tool closeout, and GitHub code scanning open alert count is `0`.
