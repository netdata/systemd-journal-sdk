...
## Pending
- `SOW-0109-20260614-python-node-netdata-edge-parity.md` - open. Created from SOW-0107 final review to audit and close remaining Python/Node edge parity findings: Python delta/data-only stop behavior, Python candidate-row callback parity, Node commit-realtime-zero handling, facet-only scan sampling, and dead local sampling-state cleanup.
