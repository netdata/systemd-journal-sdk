...
- Discrepancies: `PYTHON_DIGEST_MISMATCH`

| target | observed systemd | cases | status | discrepancy codes |
|---|---:|---:|---|---|
| ubuntu1804 | `systemd 237` | 6 | `discrepancy` | `PYTHON_DIGEST_MISMATCH` |
...
| `compress-off-archived` | 8388608 | `ok` | `failed` | `discrepancy` |
| `compress-on-active` | 8388608 | `ok` | `ok` | `ok` |
| `compress-on-archived` | 8388608 | `ok` | `failed` | `discrepancy` |
