...
- Preferred implementer model is `llm-netdata-cloud/minimax-m2.7-coder`. Fallback implementer hierarchy is `llm-netdata-cloud/qwen3.6-plus`, then `llm-netdata-cloud/glm-5.1`, then another approved model only if the active SOW records why the first fallbacks were unavailable or unsuitable. Reviewer models are `llm-netdata-cloud/kimi-k2.6`, `llm-netdata-cloud/mimo-v2.5-pro`, `llm-netdata-cloud/qwen3.6-plus`, and `llm-netdata-cloud/glm-5.1`. Evidence: `AGENTS.md`.
...
- `.agents/sow/current/SOW-0001-20260523-project-bootstrap-and-orchestration.md`: initial decisions and operating model.
